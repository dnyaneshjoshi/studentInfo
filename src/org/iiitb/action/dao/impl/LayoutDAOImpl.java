...
{
	private static final String ALL_NEWS_QUERY
		="select * from news order by news_id desc;";
	
	private static final String ANNOUNCEMENTS_QUERY
		="select a.announcement_id, a.name, a.details "+
			"from announcement a, "+
	...
	{
		ResultSet rs=connection.prepareStatement(ALL_NEWS_QUERY).executeQuery();
	...
	@Override
	public List<AnnouncementsItem> getAnnouncements(Connection connection, int userId)
			throws SQLException
	{
